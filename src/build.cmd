...
rem call %this_dir%get_testwinrt.cmd
...
if not exist %this_dir%Perf\IIDOptimizer\bin\%cswinrt_configuration%\net5.0\ (
  set guid_patch=%this_dir%Perf\IIDOptimizer\bin\%cswinrt_platform%\%cswinrt_configuration%\net5.0\*.*
) else (
